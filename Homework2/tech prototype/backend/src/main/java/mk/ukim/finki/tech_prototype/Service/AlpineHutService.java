...
public interface AlpineHutService {
    Optional<AlpineHut> post(Double x, Double y, String name, String city, String street, String houseNumber);
    Optional<AlpineHut> post(AlpineHutDTO alpineHutDTO);
    Optional<AlpineHut> findById(Long id);
    List<AlpineHut> findAll();
    Optional<AlpineHut> edit(Long id, Double x, Double y, String name, String city, String street, String houseNumber, String description, String imagePath);
